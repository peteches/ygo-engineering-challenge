...
func DefaultGeneratorPrompts() GeneratorPrompts {
	return GeneratorPrompts{
		English:  "prompts/gen_english.md",
		German:   "prompts/gen_de.md",
		French:   "prompts/gen_fr.md",
		RefineDE: "prompts/refine_de.md",
		RefineFR: "prompts/refine_fr.md",
	}
}
...
func DefaultEvaluatorPrompts() EvaluatorPrompts {
	return EvaluatorPrompts{
		ClaimExtract:         "prompts/eval_claim_extract.md",
		ClaimVerify:          "prompts/eval_claim_verify.md",
		HallucinationExtract: "prompts/eval_hallucination_extract.md",
		HallucinationVerify:  "prompts/eval_hallucination_verify.md",
		BackTranslate:        "prompts/eval_backtrans_translate.md",
		BackScore:            "prompts/eval_backtrans_score.md",
		LanguageNativeness:   "prompts/eval_language_nativeness.md",
	}
}
